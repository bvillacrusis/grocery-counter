...
public class Product {
	...
	private PromotionType promotionType; // either BUY_ONE_GET_ONE_FREE, BUY_TWO_GET_ONE_FREE
	...
	/**Returns promotion type of the product.
	 * @return The promotionType to set, either BUY_ONE_GET_ONE_FREE, BUY_TWO_GET_ONE_FREE.
	 */
	public PromotionType getPromotionType() {
		return promotionType;
	}

	/**Sets promotion type of the product.
	 * @param promotionType The promotionType to set, either BUY_ONE_GET_ONE_FREE, BUY_TWO_GET_ONE_FREE.
	 */
	...
	public String toString(){
		if(sellingType == SellingType.BY_PIECE){
			return description+String.format("%21s",GeneralUtil.formatPrice(price));
		}else if(sellingType == SellingType.BY_BULK){
			return description+"\t"+String.format("%10s",GeneralUtil.formatPrice(price));
		}else{
			return description+" "+promotionType.getPromoDescription()+String.format("%9s",GeneralUtil.formatPrice(price));
		}
