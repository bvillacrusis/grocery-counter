...
public class Products extends ArrayList<Product>{
	...
	/**
	 * Prints out the receipt associated to the 
	 * products on this list.
	 * @param summarized Set to TRUE if you printed  receipt is summarized.
	 * That is, aggregated by similar products.
	 */
	public void printReceipt(boolean summarized){
		if(summarized){
			GeneralUtil.printReceiptAggregated(this);
		}else{
			GeneralUtil.printReceipt(this);			
		}		
	}
